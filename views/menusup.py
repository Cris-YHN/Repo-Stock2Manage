...
from views.nuevo_stock import gestion_stock
from views.nuevo_proveedor import gestion_proveedores
from views.nuevo_remitos import gestion_remitos
...
def abrir_menu_supervisore(usuario):
    menusup = ctk.CTk()
